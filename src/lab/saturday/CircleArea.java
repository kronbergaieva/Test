...
import java.util.*;
/*
Calculates the area of a circle given its radiusSaturdayLab1: Data types. 
Variables. Constants. Problem 4 Write an interactive java program that accepts 
the radius of a circle from
...
public class CircleArea {
	...
	public static void main(String[] args) {
		...
		//declare String - neesmu deklar'ejusi!!!
		...
		area = PI * radius * radius;
		//output
		System.out.println("The area of a circle with radius ir:" + radius + "is" + area);
