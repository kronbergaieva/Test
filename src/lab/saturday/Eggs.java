...
SaturdayLab1: Data types. Variables. Constants.
 ...
 Read the next problem, and then identify the input, the processing
  and the output. John the farmer has asked his son with collecting the eggs from the
...
//declare constant named DOZENype Scanner and create an object
		final int DOZEN = 12;
		//declpe a variables of types int
		...
		eggsCount = sc.nextInt();//calculate the number of boxes required to store the eggs
		...
		System.out.println(" number of remainig eggs: " + eggsLeftover);
		System.out.println("==========================");
